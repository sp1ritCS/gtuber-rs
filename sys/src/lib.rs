...
pub const GTUBER_MICRO_VERSION: c_int = 0;
pub const GTUBER_MINOR_VERSION: c_int = 2;
pub const GTUBER_VERSION_S: *const c_char = b"0.2.0\0" as *const u8 as *const c_char;

// Flags
pub type GtuberCodecFlags = c_uint;
pub const GTUBER_CODEC_UNKNOWN_VIDEO: GtuberCodecFlags = 1;
pub const GTUBER_CODEC_AVC: GtuberCodecFlags = 2;
pub const GTUBER_CODEC_HEVC: GtuberCodecFlags = 4;
pub const GTUBER_CODEC_VP9: GtuberCodecFlags = 8;
pub const GTUBER_CODEC_AV1: GtuberCodecFlags = 16;
pub const GTUBER_CODEC_UNKNOWN_AUDIO: GtuberCodecFlags = 1024;
pub const GTUBER_CODEC_MP4A: GtuberCodecFlags = 2048;
pub const GTUBER_CODEC_OPUS: GtuberCodecFlags = 4096;
...
extern "C" {
    ...
    // GtuberCodecFlags
    //=========================================================================
    pub fn gtuber_codec_flags_get_type() -> GType;
    ...
    pub fn gtuber_media_info_get_adaptive_streams(info: *mut GtuberMediaInfo) -> *mut glib::GPtrArray;
    pub fn gtuber_media_info_get_chapters(info: *mut GtuberMediaInfo) -> *mut glib::GHashTable;
    ...
    pub fn gtuber_media_info_get_request_headers(info: *mut GtuberMediaInfo) -> *mut glib::GHashTable;
    pub fn gtuber_media_info_get_streams(info: *mut GtuberMediaInfo) -> *mut glib::GPtrArray;
    ...
    pub fn gtuber_stream_get_codec_flags(stream: *mut GtuberStream) -> GtuberCodecFlags;
    ...
    // Other functions
    //=========================================================================
    pub fn gtuber_has_plugin_for_uri(uri: *const c_char, filename: *mut *mut c_char) -> gboolean;
